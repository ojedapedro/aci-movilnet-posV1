...
const Invoice: React.FC<InvoiceProps> = ({ data }) => {
    ...
    return (
        <div id="printable-area" className="bg-white text-gray-800 hidden print:block w-full max-w-[210mm] mx-auto p-10 relative font-sans">
            <style>
                {`
                @media print {
                    @page { margin: 0; size: auto; }
                    body { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
                    #printable-area { padding: 10mm 15mm; width: 100%; height: 100%; }
                }
                `}
            </style>
                    ...
                    <div className="p-4">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {data.creditDetails.installments.map((inst) => (
                                <div key={inst.number} className="flex flex-col items-center justify-center border border-gray-100 rounded-lg p-3 shadow-sm">
            ...
            {/* --- FOOTER --- */}
            <div className="absolute bottom-0 left-0 w-full text-center py-6 border-t border-gray-100 bg-white">
